<?php
// source: /var/www/nette/tests/../app/config/config.neon 
// source: /var/www/nette/tests/../app/config/config.local.neon 

class Container_7b4d0a3a4b extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/nette/tests',
			'wwwDir' => '/var/www/nette/tests',
			'debugMode' => FALSE,
			'productionMode' => TRUE,
			'environment' => 'production',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/var/www/nette/tests/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/nette/tests/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/nette/tests/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_7b4d0a3a4b_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/var/www/nette/tests/../temp/cache/latte');
...
final class Container_7b4d0a3a4b_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_7b4d0a3a4b $container)
	{
